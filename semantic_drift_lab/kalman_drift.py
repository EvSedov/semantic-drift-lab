"""
Kalman Drift Detector — шаг 4 пайплайна DEMON.
...
от предсказания), что соответствует роли Калмана в DEMON: оптимальная
интеграция информации между опорными точками с учётом неопределённости.

В контексте PAI: детектирует падение качества работы (drift в
implied_sentiment) до того, как оно становится очевидным.
"""
import numpy as np
